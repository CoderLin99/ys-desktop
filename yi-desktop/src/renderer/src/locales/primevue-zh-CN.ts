/**
 * PrimeVue 简体中文 locale（源自 primefaces/primelocale zh-CN）。
 * 全局注入后，DatePicker 等组件的月份名、星期、Today/Clear 等文案一律走中文。
 */
import type { PrimeVueLocaleOptions } from '@primevue/core/config'

/** 供 `app.use(PrimeVue, { locale })` 使用的完整 zh-CN 配置 */
export const primeVueZhCN: PrimeVueLocaleOptions = {
  accept: '是',
  addRule: '添加规则',
  am: '上午',
  apply: '应用',
